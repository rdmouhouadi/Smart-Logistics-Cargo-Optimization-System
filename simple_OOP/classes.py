...
class Suitcase:
    ...
    def add_item(self, item):
        '''This function adds an items to the suitcase if suitcase total weight doesn't exceed the maximun weight'''
        current_weight = 0
    ...
    def __str__(self):
        ...
        #return f"{len(self.__items)} items ({total_weight} kg)" -------Part 2
    ...
    def heaviest_item(self):
        ...
        #retuns "None" if there are no items in the Suitcase
        if not self.__items:
            return None
...
class CargoHold:
    ...
    def __init__(self, max_weight):
        ...
        #Maximum weight capavity of the Cargo Hold
        self.__max_weight = max_weight
    ...
    def __str__(self):
        '''Returns the format: "X suitcase, space for y kg'''
